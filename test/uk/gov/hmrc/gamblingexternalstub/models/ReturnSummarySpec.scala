...
class ReturnSummarySpec extends AnyWordSpec with Matchers {
  ...
  "ReturnSummary JSON format" should {
    ...
    "serialize to JSON when defined" in {
      val model = ReturnSummary(mgdRegNumber = "GAM0000000001", returnsDue = 2, returnsOverdue = 1)
    ...
    "deserialize JSON" in {
      ...
      result shouldBe ReturnSummary(mgdRegNumber = "GAM0000000002", returnsDue = 0, returnsOverdue = 0)
    }
  }
}
