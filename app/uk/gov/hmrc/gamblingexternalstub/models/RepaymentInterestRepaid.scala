...
object RepaymentInterestRepaidItem {
  ...
  implicit val writes: OWrites[RepaymentInterestRepaidItem] = Json.writes[RepaymentInterestRepaidItem]
}
...
object RepaymentInterestRepaid {
  ...
  implicit val writes: OWrites[RepaymentInterestRepaid] = Json.writes[RepaymentInterestRepaid]
}
