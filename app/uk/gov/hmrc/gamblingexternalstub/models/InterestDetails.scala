...
final case class InterestDetailItem(
  descriptionCode: Int,
  amount: BigDecimal,
  interestId: String,
...
object InterestDetails {
  ...
  implicit val writes: OWrites[InterestDetails] = Json.writes[InterestDetails]
}
