...
object AmountDeclared {
  ...
  implicit val writes: OWrites[AmountDeclared] = Json.writes[AmountDeclared]
}
...
object ReturnsSubmitted {
  import AmountDeclared.localDateWrites
  implicit val writes: OWrites[ReturnsSubmitted] = Json.writes[ReturnsSubmitted]
}
