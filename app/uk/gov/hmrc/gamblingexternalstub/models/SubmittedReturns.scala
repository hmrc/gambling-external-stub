...
object SubmittedReturnsItem {
  ...
  implicit val writes: OWrites[SubmittedReturnsItem] = Json.writes[SubmittedReturnsItem]
}
...
object SubmittedReturns {
  implicit val writes: OWrites[SubmittedReturns] = Json.writes[SubmittedReturns]
