...
import uk.gov.hmrc.gamblingexternalstub.models.ControlBodyDetails.{fullModel, noDataModel, partialModel}
import uk.gov.hmrc.gamblingexternalstub.models.*
import uk.gov.hmrc.play.bootstrap.backend.controller.BackendController

import javax.inject.Inject

class GamblingControlBodyController @Inject() (
  ...
  def getControlBodyDetails(regime: String, mgdRegNumber: String): Action[AnyContent] = Action { _ =>
