# repayment-interest-details

**GET**

```
/gambling/repayment-interest-details/{regime}/{regNumber}?pageNo={pageNo}&pageSize={pageSize}
```

Full URL:

```
http://localhost:10405/rds-datacache-proxy/gambling/repayment-interest-details/{regime}/{regNumber}
```

Controller mapping:

`uk.gov.hmrc.gamblingexternalstub.controllers.rdsDataCacheProxy.GamblingInterestController.getRepaymentInterestDetails(regime: String, regNumber: String, pageNo: Int, pageSize: Int)`
...
Each RepaymentInterestDetails item has the following fields:
...
```
GET /gambling/repayment-interest-details/INVALID/XWM00003103200
```
...
```
GET /gambling/repayment-interest-details/gbd/XWM00003100400
```
...
```
GET /gambling/repayment-interest-details/gbd/XWM00003100401
```
...
### 404 - No RepaymentInterestDetails found

Request:

```
GET /gambling/repayment-interest-details/gbd/XWM00003100404
```
...
```
GET /gambling/repayment-interest-details/gbd/XWM00003100500
```
...
```
GET /gambling/repayment-interest-details/gbd/XWM00003100200
```
...
```
GET /gambling/repayment-interest-details/gbd/XWM00003103200
```
...
```
GET /gambling/repayment-interest-details/gbd/XWM00003350200?pageNo=1&pageSize=10
```
...
```json
{
  ...
  "totalRecords": 35,
  "items": [
    { "descriptionCode": 2640, "amount": -100.33, "interestId": "SAFE-CHG-00003", "periodStartDate": "...", "periodEndDate": "..." },
    "...",
    { "descriptionCode": 2670, "amount": -1000.33, "interestId": "SAFE-CHG-00012", "periodStartDate": "...", "periodEndDate": "..." }
  ]
}
```
...
```
curl "http://localhost:10405/rds-datacache-proxy/gambling/repayment-interest-details/gbd/XWM00003103200"
```

```
curl "http://localhost:10405/rds-datacache-proxy/gambling/repayment-interest-details/gbd/XWM00003350200?pageNo=2&pageSize=10"
```
