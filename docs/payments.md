...
```
/gambling/payments/{regime}/{regNumber}?pageNo={pageNo}&pageSize={pageSize}
```

Full URL:

```
http://localhost:10405/rds-datacache-proxy/gambling/payments/{regime}/{regNumber}
```

Controller mapping:

`uk.gov.hmrc.gamblingexternalstub.controllers.rdsDataCacheProxy.GamblingPaymentsController.getPayments(regime: String, regNumber: String, pageNo: Int, pageSize: Int)`
...
```
GET /gambling/payments/INVALID/XWM00003103200
```
...
```
GET /gambling/payments/gbd/XWM00003100400
```
...
```
GET /gambling/payments/gbd/XWM00003100401
```
...
```
GET /gambling/payments/gbd/XWM00003100404
```
...
```
GET /gambling/payments/gbd/XWM00003100500
```
...
```
GET /gambling/payments/gbd/XWM00003100200
```
...
```
curl "http://localhost:10405/rds-datacache-proxy/gambling/payments/gbd/XWM00003103200"
```

```
curl "http://localhost:10405/rds-datacache-proxy/gambling/payments/gbd/XWM00003350200?pageNo=2&pageSize=10"
```
