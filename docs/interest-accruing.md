# interest-accruing-details

**GET**

```
/gambling/interest-accruing-details/{regime}/{regNumber}?pageNo={pageNo}&pageSize={pageSize}
```
...
`uk.gov.hmrc.gamblingexternalstub.controllers.rdsDataCacheProxy.GamblingInterestController.getInterestAccruing(regime: String, regNumber: String, pageNo: Int, pageSize: Int)`
...
Each InterestAccruing item has the following fields:
...
```
GET /gambling/interest-accruing-details/INVALID/XWM00003103200
```
...
```
GET /gambling/interest-accruing-details/gbd/XWM00003100400
```
...
```
GET /gambling/interest-accruing-details/gbd/XWM00003100401
```
...
### 404 - No InterestAccruingDetails found

Request:

```
GET /gambling/interest-accruing-details/gbd/XWM00003100404
```
...
{
  "code": "NOT_FOUND",
  "message": "No InterestAccruingDetails found for the given registration number"
}
```
...
```
GET /gambling/interest-accruing-details/gbd/XWM00003100500
```
...
```
GET /gambling/interest-accruing-details/gbd/XWM00003100200
```
...
```
GET /gambling/interest-accruing-details/gbd/XWM00003103200
```
...
```
GET /gambling/interest-accruing-details/gbd/XWM00003350200?pageNo=1&pageSize=10
```
...
```
curl "http://localhost:10405/rds-datacache-proxy/gambling/interest-accruing-details/gbd/XWM00003103200"
```

```
curl "http://localhost:10405/rds-datacache-proxy/gambling/interest-accruing-details/gbd/XWM00003350200?pageNo=2&pageSize=10"
```
